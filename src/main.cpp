...
const string strMessageMagic = "YAJUCOIN Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "YAJUCOIN", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //  Coinbase(hash=12630d16a9, nTime=1507555516, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        ...
        const char* pszTimestamp = "10 Aug 1919";
        CTransaction txNew;
        txNew.nTime = 1507555516;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1507555516;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 277106 : 277106;
        ...
        assert(block.hashMerkleRoot == uint256("0x7021ac197432aff3f7e9f9a770f0fc16974a06ae3f1258804a58d7146e5c02fe"));
...
unsigned char pchMessageStart[4] = { 0x7a, 0x05, 0xfa, 0x4e };
